...
public class DashTrailModule extends Module {
   ...
   private class DashBase {
      ...
      private DashBase(LivingEntity entity, float speedDash, DashTrailModule.DashTexture dashTexture, float offsetTickPC, int rmTime) {
         ...
         this.motionY = entity.getY() - entity.prevY;
         this.motionZ = entity.getZ() - entity.prevZ;
         this.posX = entity.prevX - this.motionX * offsetTickPC + -0.0875 + 0.175 * Math.random();
         this.posY = entity.prevY - this.motionY * offsetTickPC + entity.getHeight() / 3.0F + entity.getHeight() / 4.0F * Math.random() * 0.7;
         this.posZ = entity.prevZ - this.motionZ * offsetTickPC + -0.0875 + 0.175 * Math.random();
